...
class LCTGenBaseDataset(Dataset):
    ...
    def _get_vec_based_rep(self, case_info):
        ...
        agent_abs_ = np.zeros([b_s, max_agent_num, 2])
        ...
        for i in range(agent.shape[0]):
            ...
            agent_abs_i = agent_abs[i][start_mask]
        ...
        case_info["agent_abs"] = agent_abs_
    ...
    def _process(self, data, index):
        ...
        # Custom: Add absolute position of agents
        case_info['agent_abs'] = copy.deepcopy(data['all_agent'][..., :2])
        ...
        # Custom: Add `agent_abs` to `future_attrs`
        future_attrs += ["agent_abs"]
        # print('case_info[agent_abs]:', case_info['agent_abs'])
